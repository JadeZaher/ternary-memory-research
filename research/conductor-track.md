...
stateDiagram-v2
    ...
    Gate15_Frontier: Gate 15 - Track D-4 Frontier Multi-Corpus Pretraining (QUEUED)
...
| **Gate 15** | Track D-4: Frontier Scale Multi-Corpus Pretraining | NaviTrit-135M (12 layers, 135M params, 27MB packed footprint) on streaming balanced 4-way multi-corpus (FineWeb-EDU 50%, TinyStories 20%, GSM8K 15%, Python Code 15%). Capped at 100M tokens, max 6.0 GB VRAM, 6.0h wall time on single RTX 4060. Spec: `research/frontier-scale-track.md`. | **QUEUED** |
